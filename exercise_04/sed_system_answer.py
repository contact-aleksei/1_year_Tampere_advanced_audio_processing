...
class SEDSystem(Module):
    ...
    def __init__(self,
                 ...
                 rnn_input_features: int,
                 rnn_output_features: int,
                 output_classes: int,
                 dropout: float) -> None:
        ...
        :param rnn_input_features: Input features to the RNN.
        :type rnn_input_features: int
        :param rnn_output_features: Output features of the RNN.
        :type rnn_output_features: int
        ...
        self.rnn = GRU(input_size=rnn_input_features,
                       hidden_size=rnn_output_features,
                       num_layers=1, batch_first=True)

        self.classifier = Linear(in_features=rnn_output_features,
    ...
    def forward(self,
        ...
        h = self.block_1(h)
        h = self.block_2(h)
        h = h.permute(0, 2, 1, 3).contiguous().view(x.size()[0], t_steps, -1)
